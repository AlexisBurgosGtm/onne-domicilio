...
router.get("/buscarproducto", async(req,res)=>{
    ...
    let qry ='';
            ...
            qry = `SELECT TOP (30) COMMUNITY_PRODUCTOS_SYNC.CODPROD, COMMUNITY_PRODUCTOS_SYNC.DESPROD, COMMUNITY_PRECIOS_SYNC.CODMEDIDA, COMMUNITY_PRECIOS_SYNC.EQUIVALE, 
...
FROM            COMMUNITY_PRODUCTOS_SYNC LEFT OUTER JOIN
            ...
            COMMUNITY_MARCAS ON COMMUNITY_PRODUCTOS_SYNC.CODMARCA = COMMUNITY_MARCAS.CODMARCA AND COMMUNITY_PRODUCTOS_SYNC.EMPNIT = COMMUNITY_MARCAS.EMPNIT
WHERE        (COMMUNITY_PRODUCTOS_SYNC.TOKEN = '${token}') AND (COMMUNITY_PRODUCTOS_SYNC.EMPNIT = '${empnit}') AND (COMMUNITY_PRODUCTOS_SYNC.DESPROD LIKE '%${filtro}%') OR
            (COMMUNITY_PRODUCTOS_SYNC.TOKEN = '${token}') AND (COMMUNITY_PRODUCTOS_SYNC.EMPNIT = '${empnit}') AND (COMMUNITY_PRODUCTOS_SYNC.CODPROD = '${filtro}')` 
